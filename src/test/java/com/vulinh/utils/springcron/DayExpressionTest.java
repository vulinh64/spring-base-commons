...
import static com.vulinh.utils.springcron.data.DayExpression.*;
...
class DayExpressionTest {
  ...
  static Stream<Arguments> validProvider() {
    return Stream.of(
        ...
        of(SPECIFIC_DAY_INTERVALS, "1-25", new int[] {1, 20, 10, 25}),
        of(SPECIFIC_DAY_INTERVALS, "1-10,20-25", new int[] {1, 10, 20, 25}),
  ...
  static Stream<Arguments> invalidProvider() {
    return Stream.of(
        ...
        of(SPECIFIC_DAY_INTERVALS, new int[] {1, 20, 10, 35}),
        of(SPECIFIC_DAY_INTERVALS, new int[] {-1, 20, 10, 25}),
        of(SPECIFIC_DAY_INTERVALS, new int[] {1, 10, 7}),
        of(SPECIFIC_DAY_INTERVALS, new int[] {1, 10, 1, 6, 1, 5}),
