...
public class SpecificationBuilder {
  ...
  public static <E, F> Specification<E> in(
    ...
    return isEmpty(collection)
        ? null
        : (root, criteriaQuery, criteriaBuilder) -> root.get(attribute).in(collection);
  }
  ...
  public static <E, F> Specification<E> notIn(
      SingularAttribute<? super E, F> attribute, Collection<? extends F> collection) {
    return isEmpty(collection) ? null : Specification.not(in(attribute, collection));
  }

  // field is null
  public static <E> Specification<E> isNull(SingularAttribute<? super E, ?> attribute) {
    return (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.isNull(root.get(attribute));
  }

  // field is not null
  public static <E> Specification<E> notNull(SingularAttribute<? super E, ?> attribute) {
    return (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.isNotNull(root.get(attribute));
  }

  // field = true
  public static <E> Specification<E> isTrue(SingularAttribute<? super E, Boolean> attribute) {
    return (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.isTrue(root.get(attribute));
  }

  // field = false
  public static <E> Specification<E> isFalse(SingularAttribute<? super E, Boolean> attribute) {
    return (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.isFalse(root.get(attribute));
  }
  ...
  public enum SpecificationOperation {
    ...
    SpecificationOperation(Specification<?> firstChainSpecification) {
      this.firstChainSpecification = firstChainSpecification;
    }
